...
try:
    if __package__ is not None:
        ...
        csv_transpose_path_in = os.path.join(os.path.dirname(__file__), "earthworm_qaqc_in_transpose.csv")
...
try:
    if __package__ is not None:
        ...
        csv_transpose_path_exp = os.path.join(os.path.dirname(__file__), "earthworm_qaqc_exp_transpose.csv")
