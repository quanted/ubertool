...
rest_url_varroapop = 'http://127.0.0.1:5000' #temp - local flask VarroaPy host
...
class VarroapopFunctions(object):
    ...
    def get_input_file(self, api_sessionid):
        file_endpoint =  (rest_url_varroapop + '/varroapop/files/input/'  + api_sessionid)
        return requests.get(file_endpoint)


    def get_log_file(self, api_sessionid):
        file_endpoint =  (rest_url_varroapop + '/varroapop/files/logs/'  + api_sessionid)
        return requests.get(file_endpoint)


    def get_results_file(self, api_sessionid):
        file_endpoint =  (rest_url_varroapop + '/varroapop/files/output/'  + api_sessionid)
        return requests.get(file_endpoint)
