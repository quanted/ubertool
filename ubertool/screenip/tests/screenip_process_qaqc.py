...
csv_path = os.path.join(os.path.dirname(__file__),"screenip_qaqc.csv")
csv_in = os.path.join(os.path.dirname(__file__),"screenip_qaqc_in_transpose.csv")
csv_exp = os.path.join(os.path.dirname(__file__),"screenip_qaqc_exp_transpose.csv")
