...
class TestBeerex(unittest.TestCase):
    ...
    def test_beerex_aw_cell_acute_rq(self):
        ...
        try:
            ...
            beerex_empty.out_awcell_total_dose = pd.Series([87.4, 18.6])
    ...
    def test_beerex_aw_brood_acute_rq(self):
        ...
        try:
            ...
            beerex_empty.out_awbrood_total_dose = pd.Series([23.5, 12.4])
    ...
    def test_beerex_aw_comb_acute_rq(self):
        ...
        try:
            ...
            beerex_empty.out_awcomb_total_dose = pd.Series([62.8, 22.9])
    ...
    def test_beerex_aw_pollen_acute_rq(self):
        ...
        try:
            ...
            beerex_empty.out_awpollen_total_dose = pd.Series([6.9, 33.5])
    ...
    def test_beerex_aw_nectar_acute_rq(self):
        ...
        try:
            ...
            beerex_empty.out_awnectar_total_dose = pd.Series([124.7, 2.8])
    ...
    def test_beerex_aw_winter_acute_rq(self):
        ...
        try:
            ...
            beerex_empty.out_awwinter_total_dose = pd.Series([0.54, 22.6])
    ...
    def test_beerex_aw_cell_chronic_rq(self):
        ...
        try:
            ...
            beerex_empty.out_awcell_total_dose = pd.Series([8.4, 29.7])
    ...
    def test_beerex_aw_brood_chronic_rq(self):
        ...
        try:
            ...
            beerex_empty.out_awbrood_total_dose = pd.Series([0.5, 24.1])
    ...
    def test_beerex_aw_comb_chronic_rq(self):
        ...
        try:
            ...
            beerex_empty.out_awcomb_total_dose = pd.Series([12.8, 0.65])
    ...
    def test_beerex_aw_pollen_chronic_rq(self):
        ...
        try:
            ...
            beerex_empty.out_awpollen_total_dose = pd.Series([16.9, 17.9])
    ...
    def test_beerex_aw_nectar_chronic_rq(self):
        ...
        try:
            ...
            beerex_empty.out_awnectar_total_dose = pd.Series([4.7, 0.35])
    ...
    def test_beerex_aw_winter_chronic_rq(self):
        ...
        try:
            ...
            beerex_empty.out_awwinter_total_dose = pd.Series([54., 93.1])
