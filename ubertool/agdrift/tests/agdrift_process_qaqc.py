...
csv_path = "./agdrift_qaqc.csv"
csv_in = "./agdrift_qaqc_in_transpose.csv"
csv_exp = "./agdrift_qaqc_exp_transpose.csv"

#skiprows 0-indexed (supposably, but does not seem to be the case)
#skipfooter- number of rows at bottom to skip
try:
    pd_obj_inputs = pd.read_csv(csv_path, index_col=0, header=None, skiprows=1, skipfooter=18, engine='python')
    ...
    pd_obj_exp_out = pd.read_csv(csv_path, index_col=0, header=None, skiprows=34, engine='python')
