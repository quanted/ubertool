...
class Agdrift(UberModel, AgdriftInputs, AgdriftOutputs):
    ...
    def load_data(self):
        ...
        logging.info(type(self.pond_aerial_f2m))
        logging.info(self.pond_aerial_f2m)
    ...
    def express_extrapolate_f(self):
        ...
        self.out_init_avg_dep_foa = [(0.5 * (
            self.out_y[0][i] * (yp - int(self.distance[0])) + self.out_y[0][i + 1] * (int(self.distance[0]) - ym))) / 100]
    ...
    def deposition_foa_to_lbac_f(self):
        ...
        self.out_avg_depo_lbac = [self.out_init_avg_dep_foa[0] * self.application_rate[0]]
        # print self.out_avg_depo_lbac
    ...
    def deposition_gha_to_ngl_f(self):
        ...
        if (self.aquatic_type == '1'):
            self.out_deposition_ngl = [self.out_avg_depo_gha[0] * 0.05 * 1000.0]
        else:
            self.out_deposition_ngl = [self.out_avg_depo_gha[0] * 0.05 * 1000.0 * (6.56 / 0.4921)]
    ...
    def deposition_gha_to_mgcm_f(self):
        ...
        :return:
        """
        self.out_deposition_mgcm = [self.out_avg_depo_gha[0] * 0.00001]
    ...
    def deposition_ngl_2_gha_f(self):
        ...
        if (self.aquatic_type == '1'):
            self.out_avg_depo_gha = [self.out_deposition_ngl[0] / (0.05 * 1000)]
        else:
            self.out_avg_depo_gha = [((self.out_deposition_ngl[0] / 6.56) * 0.4921) / (0.05 * 1000)]
        return self.out_avg_depo_gha
