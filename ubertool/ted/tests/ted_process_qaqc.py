...
csv_path = os.path.join(os.path.dirname(__file__),"ted_qaqc.csv")
csv_in = os.path.join(os.path.dirname(__file__),"ted_qaqc_in_transpose.csv")
csv_exp = os.path.join(os.path.dirname(__file__),"ted_qaqc_exp_transpose.csv")
import pandas as pd
...
try:
    ...
    pd_obj_exp_out = pd.read_csv(csv_path, index_col=0, header=None, skiprows=199, engine='python', na_values='')
