...
csv_path = "./kabam_qaqc.csv"
csv_in = "./kabam_qaqc_in_transpose.csv"
csv_exp = "./kabam_qaqc_exp_transpose.csv"
import pandas as pd
...
try:
    ...
    pd_obj_exp_out = pd.read_csv(csv_path, index_col=0, header=None, skiprows=357, engine='python', na_values='')
